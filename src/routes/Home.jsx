...
const Home = () => {
  return (
    <div className="w-full pt-[15vh] ">
      <div className="bg-gray-200 py-10 px-10  md:px-32">
        <div className="container mx-auto">
          ...
          <div className="m-0">
            <h2 className="subtitle1">Solicitação de certidão</h2>
            <div className="container flex flex-wrap">
              <p className="max-w-96  mb-6">
                Você pode tanto estar solicitando uma certidão tanto
                pessoalmente quanto pelo nosso WhatsApp, e-mail e site, basta
                acessar a área solicitar certidão ou clicar no botão ao lado.
              </p>
              <div className=" sm:ml-32 flex justify-center items-center">
                <Link to={"solicitarcertidao"}>
                  <button className="bg-green-700 hover:bg-green-600 rounded-xl text-white text-xl px-6 h-14 w-60 sm:w-80">
                    solicitar certidão
                  </button>
                </Link>
              </div>
      ...
      <div>
        <div className="container py-10 px-10  md:px-32">
          <h2 className="subtitle1">Localização</h2>
          <p className="">
      ...
      <div>
        <div className="py-10 px-10 sm:px-32">
          <h2 className="subtitle1">Dúvidas</h2>
          <p className="mb-2">
